...
int32_t SysInstallerManagerHelper::StartUpdateABPackageZip(const std::string &taskId,
    const std::vector<std::string> &pkgPath)
{
    return -1;
}
...
int32_t SysInstallerManagerHelper::StartAbSync()
{
    return -1;
}
...
int32_t SysInstallerManagerHelper::UpdateCloudRomVersion(const std::string &baseVersion)
{
    return -1;
}
