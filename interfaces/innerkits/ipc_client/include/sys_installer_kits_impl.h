...
public:
    ...
    virtual int32_t StartUpdateSingularPackageZip(const std::string &taskId, const std::vector<std::string> &pkgPath);
    ...
    virtual int32_t VabUpdateActive(VabUpdateActive mode);
